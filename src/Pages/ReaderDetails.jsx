import { Descriptions, Flex, Spin, Timeline, Typography } from "antd";
...
const ReaderDetails = () => {
    ...
    return (
        <Flex justify='center' vertical>
            <Typography.Text>Сведения о читателе</Typography.Text>
            <Descriptions
                layout="vertical"
                extra={[

                ]}
                title={<Typography.Title level={3}>{`${data.lastName} ${data.firstName} ${data.patronymic}`}</Typography.Title>} bordered items={items} />
        </Flex>
    )
}
